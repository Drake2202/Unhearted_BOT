...
let sticker2A = /ok|xD|xd|XD/i
let sticker2B = sticker2A.exec(m.text)

let sticker3A = /Gracias|gracias|grasias/i
let sticker3B = sticker3A.exec(m.text)

let sticker4A = /bueno|Bueno|bien/i
