...
{index: 1, urlButton: {displayText: 'Unhearted', url: 'https://github.com/Drake2202/Unhearted_BOT'}},
  ...
  if (command == 'juegos') { 
    ...
    let gata = `${pickRandom([`𝙋𝙪𝙚𝙙𝙚𝙨 𝙂𝙖𝙣𝙖𝙧 𝘿𝙞𝙖𝙢𝙖𝙣𝙩𝙚𝙨 𝙖𝙡 𝙅𝙪𝙜𝙖𝙧!!`,`𝙎𝙖𝙗𝙞𝙖𝙨 𝙦𝙪𝙚 𝙥𝙪𝙚𝙙𝙚𝙨 𝙂𝙖𝙣𝙖𝙧 𝙀𝙭𝙥𝙚𝙧𝙞𝙚𝙣𝙘𝙞𝙖 𝙖𝙡 𝙅𝙪𝙜𝙖𝙧? 𝘼𝙝𝙤𝙧𝙖 𝙮𝙖 𝙡𝙤 𝙨𝙖𝙗𝙚𝙨!!`])}`
             let c = `${usedPrefix}`
              ...
              let ss = await `Unhearted`

 const templateButtonsReplyMessage = [
{index: 1, urlButton: {displayText: 'Unhearted', url: 'https://github.com/DIEGO-OFC/DORRAT-BOT-MD'}},
